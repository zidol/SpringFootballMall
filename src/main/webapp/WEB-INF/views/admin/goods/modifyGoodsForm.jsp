				  ...
				  <select name="goods_sort">
					<c:choose>
				      <c:when test="${goods.goods_sort=='footballshoes' }">
						...
						<option value="uniform_top" >유니폼 상의</option>
						<option value="uniform_pants" >유니폼 하의</option>
						...
						<option value="sweater" >크루탑</option>
						<option value="sox" >양말</option>
						<option value="uniform_top" selected >유니폼 상의</option>
						<option value="uniform_pants" >유니폼 하의</option>
						<option value="train" >트레이닝복</option>
						<option value="accessorie" >악세사리</option>
				  	  </c:when>
						...
						<option value="sox" >양말</option>
						<option value="uniform_top" >유니폼 상의</option>
						<option value="uniform_pants" selected>유니폼 하의</option>
						<option value="train" >트레이닝복</option>
						<option value="accessorie" >악세사리</option>
				  	  </c:when>
