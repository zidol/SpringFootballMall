			...
			<tbody>
				...
				<tr class="dot_line">
					...
					<td>
					 ...
					 <c:choose> 
					   <c:when test="${member_info.sms_yn=='true' }">
				...
				<tr class="dot_line">
					...
					<c:choose> 
					   <c:when test="${member_info.email_yn=='true' }">
				...
				<tr class="dot_line">
					...
					<td>
					  ...
					  <br>
					  <p> 
					   지번 주소:<br><input type="text" id="roadAddress"  name="roadAddress" size="50" value="${member_info.road_address }"><br><br>
					  도로명 주소: <input type="text" id="jibunAddress" name="jibunAddress" size="50" value="${member_info.jibun_address }"><br><br>
					  나머지 주소: <input type="text"  name="namujiAddress" size="50" value="${member_info.detail_address }" />
