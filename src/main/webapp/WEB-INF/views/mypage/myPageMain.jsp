...
<body>
	<h1>
		최근주문내역 <a href="#"> <img src="${contextPath}/resources/image/btn_more_see.jpg"></a>
	</h1>
	...
	<br>
	<h1>
		나의 정보 <a href="#"> <img src="${contextPath}/resources/image/btn_more_see.jpg" /></a>
	</h1>
	<table border=0 width=100% cellpadding=10 cellspacing=10>
		<tr>
			<td>
		...
		<tr>
			<td>주소</td>
			<td>도로명: &nbsp;&nbsp; <strong>${memberInfo.road_address }</strong>
				<br> 지번: &nbsp;&nbsp; <strong>${memberInfo.detail_address }</strong>
			</td>
		</tr>
	</table>
</body>
