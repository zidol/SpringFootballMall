...
import com.shoppingmall.admin.member.service.AdminMemberService;
...
public class AdminMemberControllerImpl extends BaseController  implements AdminMemberController{
	...
	public void modifyMemberInfo(HttpServletRequest request, HttpServletResponse response)  throws Exception{
		...
		if(mod_type.equals("member_birth")){
			...
			memberMap.put("email_yn", val[2]);
		}else if(mod_type.equals("address")){
			val=value.split(",");
			memberMap.put("zipcode",val[0]);
			memberMap.put("road_address",val[1]);
			memberMap.put("jibun_address", val[2]);
			memberMap.put("detail_address", val[3]);
	...
	public ModelAndView deleteMember(HttpServletRequest request, HttpServletResponse response)  throws Exception {
		...
		memberMap.put("delete_yn", delete_yn);
		memberMap.put("member_id", member_id);
