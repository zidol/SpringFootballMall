...
public class GoodsVO {
	...
	private Date goods_production_date;
	...
	public Date getGoods_production_date() {
		return goods_production_date;
	}
	public void setGoods_production_date(Date goods_production_date) {
		this.goods_production_date = goods_production_date;
	}
